        ...
        <div className="form-card">
            ...
            <div className="card-body">
                ...
                <div className="input-group" style={{ marginBottom: '1.5rem' }}>
                    <label htmlFor="itunes-date" className="form-label">
                        Дата старта
                    </label>
                    <input
                        id="itunes-date"
                        ...
                        onChange={(e) => handlePlatformChange('itunes', 'startDate', e.target.value)}
                ...
                <div className="form-row">
                    <div className="input-group">
                        <label htmlFor="itunes-release-price" className="form-label">
                            Ценовая категория релиза
                            <span
                                className="info-icon"
                                title="Выберите ценовую категорию для всего релиза"
                            >
                                ⓘ
                            </span>
                        </label>
                        <select
                            id="itunes-release-price"
                            value={platformData.releasePriceCategory || ''}
                            onChange={(e) => handlePlatformChange('itunes', 'releasePriceCategory', e.target.value)}
                            className="input-field form-select"
                        >
                            {releasePriceCategories.map(cat => (
                    ...
                    <div className="input-group">
                        <label htmlFor="itunes-track-price" className="form-label">
                            Ценовая категория трека
                            <span
                                className="info-icon"
                                title="Выберите ценовую категорию для треков"
                            >
                                ⓘ
                            </span>
                        </label>
                        <select
                            id="itunes-track-price"
                            value={platformData.trackPriceCategory || 'mid'}
                            onChange={(e) => handlePlatformChange('itunes', 'trackPriceCategory', e.target.value)}
                            className="input-field form-select"
                        >
                            {trackPriceCategories.map(cat => (
                                <option key={cat.value} value={cat.value}>
                                    {cat.label}
                                </option>
                            ))}
